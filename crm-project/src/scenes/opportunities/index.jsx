...
const filteredRecords = records.filter(record => {
  ...
  switch (selectedOption) {
    ...
    case "Closing_Next_Month":
      return closeDate.getMonth() === nextMonth && closeDate.getFullYear() === now.getFullYear();
    case "Closing_Last_Month":
        return closeDate.getMonth() === lastMonth && closeDate.getFullYear() === now.getFullYear();
    case "New_This_Week":
      return createdDate >= thisWeekStart && createdDate <= thisWeekEnd;
    case "New_Last_Week":     
      return createdDate >= lastWeekStart && createdDate <= lastWeekEnd;
    case "New_This_Month":
      return createdDate.getMonth() === currentMonth && createdDate.getFullYear() === now.getFullYear();
    case "New_Last_Month": 
